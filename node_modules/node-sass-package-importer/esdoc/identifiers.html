...
<div data-ice="classSummary"><h2 id="class">Class Summary</h2><table class="summary" data-ice="summary">
  ...
  <tr data-ice="target">
    ...
    <td>
      <div>
        <p>
           <span data-ice="name"><span><a href="class/js/lib/PackageImporter.js~PackageImporter.html">PackageImporter</a></span></span>
        </p>
      </div>
      <div>
        
        
        <div data-ice="description"><p>Import packages from the <code>node_modules</code> directory.</p>
</div>
      </div>
    </td>
    <td>
